                ...
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="space-y-2 mt-4 text-sm text-gray-600">
                        ...
                        <div class="flex items-center">
                            ...
                            Mulai: <span class="font-bold ml-1 text-red-600">{{ $apel->waktu_apel ? \Carbon\Carbon::parse($apel->waktu_apel)->subHours(2)->format('H:i') : '--:--' }}</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            Batas Kehadiran: <span class="font-bold ml-1 text-red-600">{{ $apel->waktu_apel ? \Carbon\Carbon::parse($apel->waktu_apel)->format('H:i') : '--:--' }}</span>
                        </div>
                    </div>
